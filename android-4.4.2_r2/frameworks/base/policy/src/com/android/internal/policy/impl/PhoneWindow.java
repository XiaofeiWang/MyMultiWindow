...
public class PhoneWindow extends Window implements MenuBuilder.Callback {
    ...
    MultiWindowDecorView mMultiWindowDecorView;
    ...
    protected ViewGroup generateLayout(DecorView decor, int offset) {
    ...
    private void installMultiWindowDecor(DecorView decor) {
    	if (mMultiWindowDecorView == null) {
        	mMultiWindowDecorView = new MultiWindowDecorView();
    	}
...
//            }
    ...
    private final class MultiWindowDecorView {
        ...
        public MultiWindowDecorView() {
            ...
            mDecorView = getLayoutInflater().inflate(com.android.internal.R.layout.multiwindow_decor, null);
